...
urlpatterns = [
    ...
    path(
        "my_delete_options/", views.MyDeleteOptions.as_view(), name="my_delete_options"
    ),
    path("for-me/", views.ForMeSpotteds.as_view(), name="forme_spotteds"),
    path(
        "forme_delete_options/",
        views.ForMeDeleteOptions.as_view(),
        name="forme_delete_options",
    ),
    ...
    path(
        "prefetch_facebook_users/",
        views.PrefetchFacebookUsernames.as_view(),
        name="prefetch_facebook_users",
    ),
    path("imgur_upload/", views.ImgurUpload.as_view(), name="upload_image"),
    path("coinhive/", views.Coinhive.as_view(), name="coinhive"),
    path(
        "coinhive_stats/", views.GetCoinhiveStats.as_view(), name="get_coinhive_stats"
    ),
