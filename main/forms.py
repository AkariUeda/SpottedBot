...
class ContactForm(forms.Form):
    ...
    text = forms.CharField(
        widget=forms.Textarea(attrs={"rows": 4, "cols": 15}), label="Mensagem"
    )
    ...
    def send(self):
        ...
        send_mail(
            ...
            + ", "
            + email
            + ", enviou um email pelo site do Spotted:\n\n---------\n"
            + text
            + "\n---------\n\nLove,\nSpotted Bot.",
            email,
...
class ReportForm(forms.Form):
    ...
    def clean_number(self):
        ...
        try:
            ...
            raise forms.ValidationError("Não existe Spotted com esse ID")
        return i
