...
def base_query(uid):
    ...
    buttons = [
        {"type": "postback", "title": "Mandar spotted", "payload": "send_spotted"},
        {
            "type": "postback",
            "title": "Dúvidas ou problemas",
            "payload": "ask_question",
        },
        {"type": "postback", "title": "Nenhum dos dois!", "payload": "other"},
    ]
...
def send_spotted(uid):
    ...
    button = {"type": "web_url", "url": url, "title": "Enviar now!"}
    payload = {"template_type": "button", "text": message2, "buttons": [button]}
